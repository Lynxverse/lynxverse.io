...
<div className=" flex relative z-20 items-center">
    <div className="container mx-auto px-6 flex flex-col justify-between items-center relative py-8">
        <div className="flex flex-col">
            <h1 className="font-title text-center text-4xl sm:text-5xl dark:text-white text-gray-800">
                Our Current Campaign - Maja x Lynxverse
            </h1>
            <h2 className="font-description text-[1rem] leading-relaxed text-[#D8D8D8] md:text-description  max-w-4xl mx-auto w-full text-center py-8">
